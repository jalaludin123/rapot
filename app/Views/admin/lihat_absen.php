        ...
        <div class="d-block bg-white rounded shadow p-3">
          <div class="card">
            <div class="card-header head-card">
              ...
              ?>
              <a href="<?= base_url('admin/laporan/siswa/' . $id_kelas . '/' . $id_semester . '/' . $tahun['id_thn']); ?>"
                ...
                <div class="col-md-6">
                  <table class="table table-borderless">
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td>
                        <input type="text" value="<?= $wali['nama']; ?>" disabled readonly>
                      </td>
                    </tr>
                    <tr>
                      <td>Semester</td>
                ...
                <div class="col-md-6">
                  <table class="table table-borderless">
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td>
                        <input type="text" value="<?= $wali['nip']; ?>" disabled readonly>
                      </td>
                    </tr>
                    <tr>
                      <td>Tahun</td>
