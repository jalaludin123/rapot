        ...
        <div class="d-block bg-white rounded shadow p-3">
          <div class="card">
            <div class="card-header head-card">
              ...
              <a href="<?= base_url('admin/laporan/siswa/' . $siswa['id_kelas'] . '/' . $semester['id_semester'] . '/' . $tahun['id_thn']); ?>"
                  ...
                  <table class="table table-borderless">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <input type="text" value="<?= $walikelas['nama']; ?>" disabled readonly>
                ...
                <div class="col-md-6">
                  <table class="table table-borderless">
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td>
                        <input type="text" value="<?= $walikelas['nip']; ?>" disabled readonly>
                      </td>
                    </tr>
                    <tr>
                      <td>Tahun</td>
            ...
            <ul class="nav nav-tabs">
              <li class="nav-item menu-item">
                <a class="nav-link menu-link"
                  href="<?= base_url('admin/laporan/lihat_nilai/' . $siswa['id_siswa'] . '/' . $semester['id_semester'] . '/' . $tahun['id_thn']); ?>"><b>Nilai</b></a>
              </li>
              <li class="nav-item menu-item">
                <a class="nav-link menu-link"
                  href="<?= base_url('admin/laporan/lihat_absen/' . $siswa['id_siswa'] . '/' . $semester['id_semester'] . '/' . $tahun['id_thn']); ?>"><b>Keterampilan</b></a>
              </li>
            </ul>
